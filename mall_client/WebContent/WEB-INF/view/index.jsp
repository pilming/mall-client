                    ...
                    <div class="header-top-menu">
                    	<form action = "${pageContext.request.contextPath}/LoginController" method = "post">
	                    	<ul class = "nav navbar-nav notika-top-nav">
	                    		<li class = "nav-item">
	                    			<input type = "text" style="margin: 25px 0px 20px 20px" placeholder="example@exam.com" name = "clientMail">
	                    		</li>
	                    		<li class = "nav-item">
	                    			<input type = "text" style="margin: 25px 0px 20px 20px" placeholder="Password" name = "clientPw">
	                    		</li>
	                    		<li class = "nav-item">
	                    			<button type = "submit" class ="btn" style="margin: 20px 0px 20px 20px">Login</button>
	                    		</li>
	                    		<li class = "nav-item">
	                    			<button type = "submit" class ="btn" style="margin: 20px 0px 20px 20px;"><a href = "${pageContext.request.contextPath}/InsertClientController" style="font-size: 14px; color:black;">SignUp</a></button>
	                    		</li>
	                    	</ul>
                    	</form>
                    </div>
